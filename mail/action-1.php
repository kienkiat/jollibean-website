...
if ($responseKeys["success"]) {
    try {
        ...
        $mail->Host = "mail.jollibean.com.sg"; //Set the SMTP server to send through
        $mail->SMTPAuth = true; //Enable SMTP authentication
        $mail->Username = "customers@jollibean.com.sg"; //SMTP username
        $mail->Password = "!@Jollibean@168"; //SMTP password
